...
public class WeChatContant {
    ...
    public static final String URL_CODE2SESSION = "https://api.weixin.qq.com/sns/jscode2session?appid=APPID&secret=SECRET&js_code=CODE&grant_type=authorization_code";
    ///////////////////////
    // 二维码相关
    ///////////////////////

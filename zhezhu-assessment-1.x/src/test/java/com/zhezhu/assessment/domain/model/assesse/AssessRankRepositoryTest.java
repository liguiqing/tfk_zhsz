...
public class AssessRankRepositoryTest extends AbstractTransactionalJUnit4SpringContextTests {
    ...
    public void test() {
        ...
        save(RankCategory.Day,rankDate,nodes,ranks,promotes,schoolId,personId);
        ...
        save(RankCategory.Weekend,rankDate,nodes,ranks,promotes,schoolId,personId);
        ...
        save(RankCategory.Month,rankDate,nodes,ranks,promotes,schoolId,personId);
        nodes = new String[]{"1"};
        rankDate = new String[]{"2019-01-28"};
        ranks = new int[]{3};
        promotes = new int[]{1};
        save(RankCategory.Term,rankDate,nodes,ranks,promotes,schoolId,personId);

        List<AssessRank> dayRanks = repository.findAllBySchoolIdAndPersonIdAndRankCategoryAndRankScopeAndRankDateBetween(schoolId,
        ...
        dayRanks = repository.findAllBySchoolIdAndPersonIdAndRankCategoryAndRankScopeAndRankDateBetween(schoolId,
                personId,RankCategory.Day,RankScope.Clazz,
        ...
        assertEquals(schoolId,dayRanks.get(2).getSchoolId());
        ...
        List<AssessRank> weekendRanks = repository.findAllBySchoolIdAndPersonIdAndRankCategoryAndRankScopeAndRankDateBetween(schoolId,
    ...
    private void save(RankCategory category,String[] rankDate,String[] nodes,int[] ranks,int[] promotes,SchoolId schoolId,PersonId personId){
        int i = 0;
